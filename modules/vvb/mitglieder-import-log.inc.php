...
*/
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//echo "<pre>".print_r($pathvars,true)."</pre>";
...
echo "hallo", $sql."\n";
        ...
        while ( $data = $db -> fetch_array($result,1) ) {
            ...
            $dataloop["log_list"][] = array(
                "datum" => date("d.m.Y",$data[$cfg["mitglieder"]["db"]["import_log"]["time"]]),
                "zeit"  => date("H:i",$data[$cfg["mitglieder"]["db"]["import_log"]["time"]]),
                "count" => $data[$cfg["mitglieder"]["db"]["import_log"]["count"]],
                "stamp" => $data[$cfg["mitglieder"]["db"]["import_log"]["time"]],
                "class" => $class
            );
        }
...
//        }
        ...
        // was anzeigen
        $mapping["main"] = "mitglieder-import-log";
        #$mapping["navi"] = "leer";
