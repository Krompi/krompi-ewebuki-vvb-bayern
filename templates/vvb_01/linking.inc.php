<?php
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  $script_name = "$Id: linking.inc.php 15 2011-12-13 09:08:42Z krom $";
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  #}
    ...
    if (  ( $environment["kategorie"] == "aktuell" ) )
    {
        $mapping["main"] = "aktuell-archiv";
    }
//    if (  ( $environment["ebene"] == "/aktuell" ) )
//    {
//        $mapping["main"] = "aktuell-artikel";
//    }

    if ( count($dataloop["level2"]) > 0 ) {
        $hidedata["submenu"] = array();
    }
